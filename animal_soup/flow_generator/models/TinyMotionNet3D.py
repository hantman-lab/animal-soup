...
class TinyMotionNet3D(nn.Module):
    def __init__(self,
        ...
        num_images: int, default 11
            Window flow size. Will take 11 images and compute 10 optical flow outputs.
        input_channels: int, default 3
            Number of input channels. For RGB images, should be 3.
        ...
        # if using batch norm, no need for bias
